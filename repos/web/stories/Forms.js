...
import { hourMinute, number } from 'react-ui-pack/inputs/normalizers'
import { isRequired, url } from 'react-ui-pack/inputs/validationRules'
    ...
    return (
      <View className='full-width'>
        ...
        <Row className='top center wrap margin'>
          ...
          <Select
            options={[
              {text: 'English', value: 'en', content: <img src={FILE.PATH_IMAGES + 'flags/en.svg'} alt='en'/>},
              {text: 'Русский', value: 'ru', content: <img src={FILE.PATH_IMAGES + 'flags/ru.svg'} alt='ru'/>},
            ]}
          />
